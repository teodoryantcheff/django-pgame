...
class UserProfile(models.Model):
    ...
    crypto_address = models.CharField(
        ...
        help_text='Crypto address to send shit to',
        max_length=50,
        blank=True
    )
    ...
    referrer = models.ForeignKey(
        help_text='Who brought this user into the game. Taken on account creation based on ref_code.',
        to=AUTH_USER_MODEL,
        null=True,
    ...
    ref_source = models.CharField(
        help_text='Source and campaign as set by the REFERRER who brings the guy into the game. '
                  'Used for referral statistics generation',
        max_length=64,
        default='',
        blank=True
    )
    ...
    referral_id = models.CharField(
        help_text='Personal id for the user to use when setting referral links',
        max_length=30,
        unique=True,
        blank=False
    )
